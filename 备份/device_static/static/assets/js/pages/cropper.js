...
(function (global, factory) {
  ...
  var render = {
    ...
    initContainer: function initContainer() {
      ...
      var containerData = {
        width: Math.max(container.offsetWidth, Number(options.minContainerWidth) || 300),
        height: Math.max(container.offsetHeight, Number(options.minContainerHeight) || 150)
      };
  ...
  var handlers = {
    resize: function resize() {
      ...
      var minContainerWidth = Number(options.minContainerWidth) || 300;
      var minContainerHeight = Number(options.minContainerHeight) || 150;
