    ...
    $.fn.qqFace = function (option) {
        ...
        return this.each(function () {
            ...
            if ($('#' + id).length <= 0) {
                ...
                str += '<div class="scroll-wrapper" style="max-height:200px">';
                str += '<table class="face-tb">';
                str += '</tr>';
                for (var i = 0; i < QQFaceList.length; i++) {
                    str += '<td><a href="javascript:void(0)" title="' + QQFaceList[i] + '"><img data-imgtype=\"face\" src="' + settings.path + '/qqface/' + QQFaceList[i] + '.png"  class=\"imgFace\" data-name="' + QQFaceList[i] + '"/></a></td>';
                    if ((i + 1) % 12 == 0) {
                        str += '</tr><tr>'
                    };
                }
